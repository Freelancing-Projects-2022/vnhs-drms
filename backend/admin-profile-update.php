<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        if($statusMsg === '') {
            ...
            $sql = "UPDATE user SET last_name='$lastName', first_name='$firstName', middle_name='$middleName', email_address='$emailAddress', cp_number='$cpNumber', username='$userName', password='$password', profile_picture='$profilePicture', updated_timestamp='NOW()' WHERE id = '$userId'";
            if (mysqli_query($conn, $sql)) {    
                $_SESSION['msgType']  = "success";       
                $_SESSION['msgTitle']  = "Successfully Updated!";                   
                $_SESSION['msg'] = "Profile has been updated."; 

                $_SESSION['fullName'] =  getFullName($lastName, $firstName, $middleName, true, true);
        ...
        $_SESSION['currentPage'] = "pages/admin/user-account.php";
