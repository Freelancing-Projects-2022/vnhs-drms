        ...
        <div class="col-lg-12">
            <div id="ibox" class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form class="m-t" role="form" method="POST" action="backend/admin-profile-update.php" enctype="multipart/form-data">      
                        ...
                        <div class="col-lg-9">     
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <input type="text" name="txtLastName" placeholder="Enter Last Name" class="form-control" value="<?= $lastName ?>" required>
                            </div>      
                            <div class="form-group col-sm-6">
                                <label>First Name</label>
                                <input type="text" name="txtFirstName" placeholder="Enter First Name" class="form-control" value="<?= $firstName ?>" required>
                            </div>
                            <div class="form-group col-sm-3">
                                <label>Middle Name</label>
                                <input type="text" name="txtMiddleName" placeholder="Enter Middle Name" class="form-control" value="<?= $middleName ?>" required>
                            </div> 
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <input type="text" name="txtUserName" placeholder="UserName" class="form-control" value="<?= $userName ?>">
                            </div>                                              
                            <div class="form-group col-sm-4">
